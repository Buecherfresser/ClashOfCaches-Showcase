...
const char *usage_msg =
    ...
    "Usage: ./Simulation  [options] <request_file_name> \n \n"
    ...
    "   --l1-lines <number>                     Set the size of the l1-Cache to <number> lines\n"
    "   --l2-lines <number>                     Set the size of the l2-Cache to <number> lines\n"
